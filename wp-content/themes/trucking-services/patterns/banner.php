...
<h2 class="wp-block-heading banner-heading has-secondary-color has-text-color has-link-color has-body-font-family" style="font-size:44px;font-style:normal;font-weight:600"><?php echo esc_html__( 'Seguridad y puntualidad en cada viaje', 'trucking-services' ); ?></h2>
<!-- /wp:heading -->
...
<p class="banner-para has-secondary-color has-text-color has-link-color has-body-font-family" style="font-size:20px;font-style:normal;font-weight:400"><?php echo esc_html__( 'Inversiones & Transporte Roma garantiza el transporte de carga seguro, puntual y eficiente en las principales rutas del país.', 'trucking-services' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button banner-button"><a class="wp-block-button__link has-base-color has-text-color has-link-color has-poppins-font-family has-custom-font-size wp-element-button" href="<?php echo esc_url( home_url( '/contacto/solicitar-cotizacion/' ) ); ?>" style="border-radius:10px;padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--20);font-size:14px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Solicitar cotización', 'trucking-services' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
