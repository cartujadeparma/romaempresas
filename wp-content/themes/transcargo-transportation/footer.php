          ...
          <div class="container">
            <div class="row sidebar-area footer-area">
              ...
              <div id="calendar" class="col-lg-3 col-md-6 widget_calendar wow fadeInUp" data-wow-duration="2s">
                <h4 class="title"><?php esc_html_e('Calendar', 'transcargo-transportation'); ?></h4>
                <?php get_calendar(); ?>
              </div>
            </div>
          </div>
        ...
        <p class="mb-0 py-3 text-center text-md-start">
          <?php
            if (!get_theme_mod('transcargo_transportation_footer_text') ) { ?>
              <a href="<?php echo esc_url('https://www.misbahwp.com/products/free-transportation-wordpress-theme'); ?>" target="_blank">
          ...
          <?php endif; ?>
            <?php $transcargo_transportation_footer_settings = get_theme_mod( 'transcargo_transportation_footer_social_links_settings' ); ?>
            <?php if ( is_array($transcargo_transportation_footer_settings) || is_object($transcargo_transportation_footer_settings) ){ ?>
                    <?php foreach( $transcargo_transportation_footer_settings as $transcargo_transportation_footer_setting ) { ?>
                    <a class="social-links" href="<?php echo esc_url( $transcargo_transportation_footer_setting['link_url'] ); ?>">
                        <i class="<?php echo esc_attr( $transcargo_transportation_footer_setting['link_text'] ); ?> me-3"></i>
                    </a>
                <?php } ?>
            <?php } ?>
        </p>
