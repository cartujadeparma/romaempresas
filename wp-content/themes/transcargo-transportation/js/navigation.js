// Menu Functions
function transcargo_transportation_openNav() {
  jQuery(".sidenav").addClass('show');
}

function transcargo_transportation_closeNav() {
  jQuery(".sidenav").removeClass('show');
}

/////////////////////// Focus handling ///////////////////////
(function(window, document) {
  function transcargo_transportation_handleMobileMenuNavigation() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    transcargo_transportation_handleMobileMenuNavigation();
