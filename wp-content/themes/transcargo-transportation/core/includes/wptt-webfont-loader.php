...
if ( ! class_exists( 'Transcargo_Transportation_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Transcargo_Transportation_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Transcargo_Transportation_WPTT_WebFont_Loader( $url );
